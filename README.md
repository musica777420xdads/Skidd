...
local Window = OrionLib:MakeWindow({Name = "Cuacker Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Cuacker Hub"})
...
W:AddLabel("[+] Cuacker Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Cuacker Hub(Noitification)",
